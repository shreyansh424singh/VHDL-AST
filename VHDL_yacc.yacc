...
decimal_literal : integer DOT integer exponent      ((W_datatypes.DECIMAL_LITERAL_1(integer, integer, exponent)))                    
                | integer exponent                  ((W_datatypes.DECIMAL_LITERAL_2(integer, exponent)))        
                | integer                           ((W_datatypes.DECIMAL_LITERAL_3(integer)))
                | integer DOT integer               ((W_datatypes.DECIMAL_LITERAL_4(integer, integer)))            
...
entity_declarative_item : subprogram_declaration                   ((W_datatypes.ENTITY_DECLARATIVE_ITEM_1(subprogram_declaration)))             
                        ...
                        | PSL_Property_Declaration                 ((W_datatypes.ENTITY_DECLARATIVE_ITEM_21(PSL_Property_Declaration)))             
                        | PSL_Sequence_Declaration                 ((W_datatypes.ENTITY_DECLARATIVE_ITEM_22(PSL_Sequence_Declaration)))             
                        | PSL_Clock_Declaration                    ((W_datatypes.ENTITY_DECLARATIVE_ITEM_23(PSL_Clock_Declaration)))         
...
entity_statement : concurrent_assertion_statement           ((W_datatypes.ENTITY_STATEMENT_1(concurrent_assertion_statement)))                
                 ...
                 | PSL_Directive                            ((W_datatypes.ENTITY_STATEMENT_4(PSL_Directive)))
...
exit_statement : label COLON EXIT label WHEN condition SEMICOLON     ((W_datatypes.EXIT_STATEMENT_1(label, label, condition)))                                       
               ...
               | label COLON EXIT label SEMICOLON                    ((W_datatypes.EXIT_STATEMENT_4(label, label)))                       
               | EXIT label SEMICOLON                                ((W_datatypes.EXIT_STATEMENT_5(label)))           

exponent : E PLUS integer           
         | E integer            
         | E MINUS integer          
...
expression : condition_operator primary     ((W_datatypes.EXPRESSION_1(condition_operator, primary)))        
...
external_constant_name : RIGHTDOUBLE CONSTANT external_pathname COLON subtype_indication >>        ((W_datatypes.EXTERNAL_CONSTANT_NAME(external_pathname, subtype_indication))) 

external_signal_name : RIGHTDOUBLE SIGNAL external_pathname COLON subtype_indication >>            ((W_datatypes.EXTERNAL_SIGNAL_NAME(external_pathname, subtype_indication)))     

external_variable_name : RIGHTDOUBLE VARIABLE external_pathname COLON subtype_indication >>        ((W_datatypes.EXTERNAL_VARIABLE_NAME(external_pathname, subtype_indication)))         
...
factor : unary_expression EXPT unary_expression      ((W_datatypes.FACTOR_1(unary_expression, unary_expression)))                       
...
for_generate_statement : label COLON FOR parameter_specification GENERATE generate_statement_body END GENERATE label SEMICOLON       ((W_datatypes.FOR_GENERATE_STATEMENT_1(label, parameter_specification, generate_statement_body, label)))              
...
graphic_character : basic_graphic_character      ((W_datatypes.GRAPHIC_CHARACTER_1(basic_graphic_character)))       
                  ...
                  | other_special_character      ((W_datatypes.GRAPHIC_CHARACTER_3(other_special_character)))       
...
if_generate_statement : label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement1_seq ELSE label COLON GENERATE generate_statement_body END GENERATE label SEMICOLON      ((W_datatypes.IF_GENERATE_STATEMENT_1(label, label, condition, generate_statement_body, if_generate_statement1_seq, label, generate_statement_body, label)))                                                                                                       
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement1_seq ELSE GENERATE generate_statement_body END GENERATE label SEMICOLON                  ((W_datatypes.IF_GENERATE_STATEMENT_2(label, label, condition, generate_statement_body, if_generate_statement1_seq, generate_statement_body, label)))                                                                                         
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement1_seq ELSE label SEMICOLON                                                                ((W_datatypes.IF_GENERATE_STATEMENT_3(label, label, condition, generate_statement_body, if_generate_statement1_seq, label)))                                               
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement2_seq ELSE label COLON GENERATE generate_statement_body END GENERATE label SEMICOLON      ((W_datatypes.IF_GENERATE_STATEMENT_4(label, label, condition, generate_statement_body, if_generate_statement2_seq, label, generate_statement_body, label)))                                                                                                       
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement2_seq ELSE GENERATE generate_statement_body END GENERATE label SEMICOLON                  ((W_datatypes.IF_GENERATE_STATEMENT_5(label, label, condition, generate_statement_body, if_generate_statement2_seq, generate_statement_body, label)))                                                                                         
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement2_seq ELSE label SEMICOLON                                                                ((W_datatypes.IF_GENERATE_STATEMENT_6(label, label, condition, generate_statement_body, if_generate_statement2_seq, label)))                                               
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement2_seq ELSE label COLON GENERATE generate_statement_body END GENERATE SEMICOLON            ((W_datatypes.IF_GENERATE_STATEMENT_7(label, label, condition, generate_statement_body, if_generate_statement2_seq, label, generate_statement_body)))                                                                                                
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement2_seq ELSE GENERATE generate_statement_body END GENERATE SEMICOLON                        ((W_datatypes.IF_GENERATE_STATEMENT_8(label, label, condition, generate_statement_body, if_generate_statement2_seq, generate_statement_body)))                                                                                  
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement2_seq ELSE SEMICOLON                                                                      ((W_datatypes.IF_GENERATE_STATEMENT_9(label, label, condition, generate_statement_body, if_generate_statement2_seq)))                                        
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement1_seq ELSE label COLON GENERATE generate_statement_body END GENERATE SEMICOLON            ((W_datatypes.IF_GENERATE_STATEMENT_10(label, label, condition, generate_statement_body, if_generate_statement1_seq, label, generate_statement_body)))                                                                                                
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement1_seq ELSE GENERATE generate_statement_body END GENERATE SEMICOLON                        ((W_datatypes.IF_GENERATE_STATEMENT_11(label, label, condition, generate_statement_body, if_generate_statement1_seq, generate_statement_body)))                                                                                  
                      | label COLON IF label COLON condition GENERATE generate_statement_body if_generate_statement1_seq ELSE SEMICOLON                                                                      ((W_datatypes.IF_GENERATE_STATEMENT_12(label, label, condition, generate_statement_body, if_generate_statement1_seq)))                                        
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement1_seq ELSE label COLON GENERATE generate_statement_body END GENERATE label SEMICOLON                  ((W_datatypes.IF_GENERATE_STATEMENT_13(label, condition, generate_statement_body, if_generate_statement1_seq, label, generate_statement_body, label)))                                                                                         
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement1_seq ELSE GENERATE generate_statement_body END GENERATE label SEMICOLON                              ((W_datatypes.IF_GENERATE_STATEMENT_14(label, condition, generate_statement_body, if_generate_statement1_seq, generate_statement_body, label)))                                                                                  
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement1_seq ELSE label SEMICOLON                                                                            ((W_datatypes.IF_GENERATE_STATEMENT_15(label, condition, generate_statement_body, if_generate_statement1_seq, label)))                                 
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement2_seq ELSE label COLON GENERATE generate_statement_body END GENERATE label SEMICOLON                  ((W_datatypes.IF_GENERATE_STATEMENT_16(label, condition, generate_statement_body, if_generate_statement2_seq, label, generate_statement_body, label)))                                                                                         
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement2_seq ELSE GENERATE generate_statement_body END GENERATE label SEMICOLON                              ((W_datatypes.IF_GENERATE_STATEMENT_17(label, condition, generate_statement_body, if_generate_statement2_seq, generate_statement_body, label)))                                                                                  
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement2_seq ELSE label SEMICOLON                                                                            ((W_datatypes.IF_GENERATE_STATEMENT_18(label, condition, generate_statement_body, if_generate_statement2_seq, label)))                                 
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement2_seq ELSE label COLON GENERATE generate_statement_body END GENERATE SEMICOLON                        ((W_datatypes.IF_GENERATE_STATEMENT_19(label, condition, generate_statement_body, if_generate_statement2_seq, label, generate_statement_body)))                                                                                  
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement2_seq ELSE GENERATE generate_statement_body END GENERATE SEMICOLON                                    ((W_datatypes.IF_GENERATE_STATEMENT_20(label, condition, generate_statement_body, if_generate_statement2_seq, generate_statement_body)))                                                                           
                      ...
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement1_seq ELSE label COLON GENERATE generate_statement_body END GENERATE SEMICOLON                        ((W_datatypes.IF_GENERATE_STATEMENT_22(label, condition, generate_statement_body, if_generate_statement1_seq, label, generate_statement_body)))                                                                                  
                      | label COLON IF condition GENERATE generate_statement_body if_generate_statement1_seq ELSE GENERATE generate_statement_body END GENERATE SEMICOLON                                    ((W_datatypes.IF_GENERATE_STATEMENT_23(label, condition, generate_statement_body, if_generate_statement1_seq, generate_statement_body)))                                                                           
...
if_statement : label COLON IF condition THEN sequential_statement_body if_statement_seq ELSE sequential_statement_body END IF label SEMICOLON        ((W_datatypes.IF_STATEMENT_1(label, condition, sequential_statement_body, if_statement1_seq, sequential_statement_body, label)))                                                             
             | IF condition THEN sequential_statement_body if_statement_seq ELSE sequential_statement_body END IF label SEMICOLON                    ((W_datatypes.IF_STATEMENT_2(condition, sequential_statement_body, if_statement1_seq, sequential_statement_body, label)))                                               
             | label COLON IF condition THEN sequential_statement_body if_statement_seq END IF label SEMICOLON                                       ((W_datatypes.IF_STATEMENT_3(label, condition, sequential_statement_body, if_statement1_seq, label)))                          
             ...
             | label COLON IF condition THEN sequential_statement_body if_statement_seq ELSE sequential_statement_body END IF SEMICOLON              ((W_datatypes.IF_STATEMENT_7(label, condition, sequential_statement_body, if_statement1_seq, sequential_statement_body)))                                                      
             | IF condition THEN sequential_statement_body if_statement_seq ELSE sequential_statement_body END IF SEMICOLON                          ((W_datatypes.IF_STATEMENT_8(condition, sequential_statement_body, if_statement1_seq, sequential_statement_body)))                                        
...
interface_subprogram_default : subprogram_name         ((W_datatypes.INTERFACE_SUBPROGRAM_DEFAULT_1(name)))                      
...
logical_expression : relation relation1_seq            ((W_datatypes.LOGICAL_EXPRESSION_1(relation, relation1_seq)))                      
                   ...
                   | relation NAND relation            ((W_datatypes.LOGICAL_EXPRESSION_2(relation, relation)))                      
                   | relation NOR relation             ((W_datatypes.LOGICAL_EXPRESSION_2(relation, relation)))                      
...
loop_statement : label COLON iteration_scheme LOOP sequence_of_statements END LOOP label SEMICOLON            ((W_datatypes.LOOP_STATEMENT_1(label, iteration_scheme, sequential_statement_body, label)))                                            
               | label COLON LOOP sequence_of_statements END LOOP label SEMICOLON                             ((W_datatypes.LOOP_STATEMENT_2(label, sequential_statement_body, label)))                       
...
next_statement : label COLON NEXT label WHEN condition SEMICOLON         ((W_datatypes.NEXT_STATEMENT_1(label, label, condition)))                                       
               ...
               | label COLON NEXT label SEMICOLON                        ((W_datatypes.NEXT_STATEMENT_5(label, label)))                         
