...
val MODE: (int) *  'a * 'a -> (svalue,'a) token
...
val TRUE: (int) *  'a * 'a -> (svalue,'a) token
val FALSE: (int) *  'a * 'a -> (svalue,'a) token
val FAILURE: (int) *  'a * 'a -> (svalue,'a) token
val FILE_OPEN_STATUS: (int) *  'a * 'a -> (svalue,'a) token
val FILE_OPEN_KIND: (int) *  'a * 'a -> (svalue,'a) token
val SEVERITY_LEVEL: (int) *  'a * 'a -> (svalue,'a) token
val NATURAL: (int) *  'a * 'a -> (svalue,'a) token
...
val STD_ULOGIC_VECTOR: (int) *  'a * 'a -> (svalue,'a) token
val STD_ULOGIC: (int) *  'a * 'a -> (svalue,'a) token
val STD_LOGIC_VECTOR: (int) *  'a * 'a -> (svalue,'a) token
val STD_LOGIC: (int) *  'a * 'a -> (svalue,'a) token
